...
#[derive(Component)]
pub struct TextInputSize(pub Vec2);
...
pub fn update_inputs(
    ...
    mut submit_events: MessageWriter<TextSubmission>,
) {
...
pub fn extract_text_input(
    ...
    ) in text_input_query.iter()
    {
        ...
        {
            (placeholder_layout.layout(), display_config.placeholder_text)
        } else {
            (text_layout, display_config.input_text)
        };
        ...
        extracted_sprites.sprites.push(ExtractedSprite {
            ...
            transform,
            color: display_config.input_background.into(),
        ...
        for (i, rect) in layout.selection_rects.iter().enumerate() {
            ...
            extracted_sprites.sprites.push(ExtractedSprite {
                ...
                color: display_config.selected_highlight.into(),
                image_handle_id: AssetId::default(),
                flip_x: false,
                flip_y: false,
                kind: ExtractedSpriteKind::Single {
        ...
        extracted_sprites.sprites.push(ExtractedSprite {
            ...
            color: display_config.cursor.into(),
            image_handle_id: AssetId::default(),
            flip_x: false,
            flip_y: false,
            kind: ExtractedSpriteKind::Single {
