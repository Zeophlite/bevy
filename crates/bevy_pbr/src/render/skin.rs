...
use bevy_render::mesh::skin::{SkinUniformInfo, SkinUniforms, JOINTS_PER_ALLOCATION_UNIT, MAX_JOINTS, MAX_TOTAL_JOINTS};
...
// impl FromWorld for SkinUniforms {
    pub fn skinUniforms_from_world(world: &mut World) {
