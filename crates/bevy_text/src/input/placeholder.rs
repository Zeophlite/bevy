...
use crate::{
    add_glyph_to_atlas, buffer_dimensions, get_glyph_atlas_info, load_font_to_fontdb,
    CosmicFontSystem, Font, FontAtlasKey, FontAtlasSet, FontSmoothing, PositionedGlyph, TextBounds,
    TextError, TextInputAttributes, TextInputTarget, TextLayoutInfo, TextPipeline,
...
pub fn update_placeholder_layouts(
    ...
    let mut font_system = &mut font_system.0;
